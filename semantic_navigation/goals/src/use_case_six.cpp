...
int main(int argc, char** argv)
{
    ...
    goal_one.input.geometric_goal.pose.position.x = 3.87;
    goal_one.input.geometric_goal.pose.position.y = -0.47;
    goal_one.input.geometric_goal.pose.orientation.w = 0.1;

    goal_one.input.purpose.data = "manipulate";
    ...
    goal_two.input.geometric_goal.pose.position.x = -1.0;
