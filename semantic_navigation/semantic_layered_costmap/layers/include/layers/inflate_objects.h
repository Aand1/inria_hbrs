...
namespace semantic_costmap
{
  ...
  public:
     ...
     virtual void onInitialize(costmap_2d::LayeredCostmap* parent, std::string name, tf::TransformListener *tf, double inflation_radius, double weight, double inscribed_radius);
