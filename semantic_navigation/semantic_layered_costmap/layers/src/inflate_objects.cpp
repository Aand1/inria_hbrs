...
namespace semantic_costmap
{
 ...
 // void InflateObjects::onInitialize(std::string name, double inflation_radius, double weight, costmap_2d::LayeredCostmap* parent)
  void InflateObjects::onInitialize(costmap_2d::LayeredCostmap* parent, std::string name, tf::TransformListener *tf, double inflation_radius, double weight, double inscribed_radius)
  {
    ...
    weight_ = weight; 
    inscribed_radius_ = inscribed_radius; //0.28;
