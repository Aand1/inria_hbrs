...
namespace semantic_costmap
{
    ...
    void StructuralObjectsLayer::onInitialize()
    {
     ...
     double inflation_radius = 0.9;
     double weight = 1.0;
     double inscribed_radius_ = 0.28;
...
//     dynamic_objects_.onInitialize(layered_costmap_, name_ + "_dynamic_objects", tf_);
     inflate_objects_.onInitialize(layered_costmap_, name_ + "_inflate_objects", tf_, inflation_radius, weight, inscribed_radius_); 
